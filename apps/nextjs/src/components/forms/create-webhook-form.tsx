...
export default function CreateWebhookDialog({ children, projectId }: { children: ReactNode; projectId: number; }) {
...
function CreateTokenForm({ close, projectId }: { close?: () => void; projectId: number; }) {
