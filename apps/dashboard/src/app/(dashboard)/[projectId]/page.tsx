...
type DBProject = Awaited<ReturnType<typeof api.project.getProject>>;
  ...
  return (
    <>
      <Card className="flex-grow">
        ...
        <CardContent>
          <p>
            {projectUsage.incomingMessages} /{" "}
            {formatLimitNumber(projectData.limits.incomingMessages)}
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="flex-grow">
        <CardHeader>
          ...
          <CardDescription>
            Messages that clients sent from websockets
          </CardDescription>
        </CardHeader>
        <CardContent>
          <p>
            {projectUsage.outgoingMessages} /{" "}
            {formatLimitNumber(projectData.limits.outgoingMessages)}
          </p>
        </CardContent>
      </Card>
      ...
      <Card className="flex-grow">
        ...
        <CardContent>
          <p>
            {projectUsage.concurrentConnections} /{" "}
            {formatLimitNumber(projectData.limits.concurrent)}
          </p>
        </CardContent>
      </Card>
    ...
    <>
      ...
      <div className="pt-8">
        ...
        <div className="flex flex-wrap justify-center gap-4 py-4">
          ...
          >
            <Usage projectId={parsedProjectId} projectData={project} />
          </Suspense>
        </div>
      </div>
    </>
